...
with open(FILEPATH) as f:
    for line in f.readlines():
        ...
        if intersection == firstAssignment or intersection == secondAssignment:
            fullyOverlappingPairsNumber += 1

print(fullyOverlappingPairsNumber)
